...
Source0  : https://files.pythonhosted.org/packages/3a/ed/c3876f3b3e8beba336214ce44e1efa1792dd537027cef24192ac2b077d7c/pyzmq-26.3.0.tar.gz
...
%prep
%setup -q -n pyzmq-26.3.0
cd %{_builddir}/pyzmq-26.3.0
pushd ..
cp -a pyzmq-26.3.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1742461257
