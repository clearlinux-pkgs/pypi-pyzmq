...
Source0  : https://files.pythonhosted.org/packages/e7/5d/ec9bc6f18d14f9fa6c4aa60e621096f8057c18fc1d2b320e263433abda3f/pyzmq-24.0.0.tar.gz
...
%prep
%setup -q -n pyzmq-24.0.0
cd %{_builddir}/pyzmq-24.0.0
pushd ..
cp -a pyzmq-24.0.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1663347106
