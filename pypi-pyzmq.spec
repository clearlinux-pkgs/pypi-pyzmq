...
Source0  : https://files.pythonhosted.org/packages/5a/e3/8d0382cb59feb111c252b54e8728257416a38ffcb2243c4e4775a3c990fe/pyzmq-26.2.1.tar.gz
...
%prep
%setup -q -n pyzmq-26.2.1
cd %{_builddir}/pyzmq-26.2.1
pushd ..
cp -a pyzmq-26.2.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1738267374
