...
Source0  : https://files.pythonhosted.org/packages/59/5b/2e1b7498b4a3118bf03b65c16dba9acbe9112f48415a16ae814894033f6a/pyzmq-25.0.1.tar.gz
...
%prep
%setup -q -n pyzmq-25.0.1
cd %{_builddir}/pyzmq-25.0.1
pushd ..
cp -a pyzmq-25.0.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1678721152
