...
Source0  : https://files.pythonhosted.org/packages/b1/11/b9213d25230ac18a71b39b3723494e57adebe36e066397b961657b3b41c1/pyzmq-26.4.0.tar.gz
...
%prep
%setup -q -n pyzmq-26.4.0
cd %{_builddir}/pyzmq-26.4.0
pushd ..
cp -a pyzmq-26.4.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1743780994
...
cp %{_builddir}/pyzmq-%{version}/licenses/LICENSE.tornado.txt %{buildroot}/usr/share/package-licenses/pypi-pyzmq/2b8b815229aa8a61e483fb4ba0588b8b6c491890 || :
cp %{_builddir}/pyzmq-%{version}/licenses/LICENSE.tornado.txt %{buildroot}/usr/share/package-licenses/pypi-pyzmq/2b8b815229aa8a61e483fb4ba0588b8b6c491890 || :
...
/usr/share/package-licenses/pypi-pyzmq/2b8b815229aa8a61e483fb4ba0588b8b6c491890
