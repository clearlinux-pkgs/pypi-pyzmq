...
Source0  : https://files.pythonhosted.org/packages/46/0d/b06cf99a64d4187632f4ac9ddf6be99cd35de06fe72d75140496a8e0eef5/pyzmq-24.0.1.tar.gz
...
%prep
%setup -q -n pyzmq-24.0.1
cd %{_builddir}/pyzmq-24.0.1
pushd ..
cp -a pyzmq-24.0.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1663774788
